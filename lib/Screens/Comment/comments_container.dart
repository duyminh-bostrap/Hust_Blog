...
import 'package:hust_blog/Screens/Widget/hero_tag.dart';
import 'package:hust_blog/Screens/Widget/hero_widget.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              comment.createdAt.toString().substring(8, 10)+
                  '-'+comment.createdAt.toString().substring(5, 8)+comment.createdAt.toString().substring(0, 4)
